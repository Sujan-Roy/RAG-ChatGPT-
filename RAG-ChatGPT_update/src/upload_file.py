...
class UploadFile:
    ...
    def process_uploaded_files(files_dir: List, chatbot: List, rag_with_dropdown: str) -> Tuple:
        ...
        if rag_with_dropdown == "Upload doc: Process for RAG":
            ...
            # ja_translation= Translator.trans()
            # print(ja_translation)
            # chatbot.append(
            #     (" English= ", final_summary),
            #     ("Japanese= ", ja_translation))
            chatbot.append(("Please wait...... ", final_summary))
            #chatbot.append(("Japanese= ", ja_translation))
        else:
            chatbot.append(
