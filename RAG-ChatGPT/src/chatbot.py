        ...
        if data_type == "Preprocessed doc":
            ...
            if os.path.exists(APPCFG.persist_directory):
                vectordb = Chroma(persist_directory=APPCFG.persist_directory,
                                 # embedding_function=OpenAIEmbeddings(deployment="text-emb-ada-002")
            ...
            print("Upload doc: Process for RAG")
            print("Model Engine Doc: ", APPCFG.embedding_model)
            if os.path.exists(APPCFG.custom_persist_directory):
                ...
                print("Presisit Directory: ", vectordb) 
            else:
                chatbot.append(
