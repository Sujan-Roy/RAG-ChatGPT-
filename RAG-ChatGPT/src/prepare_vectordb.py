...
class PrepareVectorDB:
    ...
    def __init__(
        ...
        print('embedding_model_engine= ', self.embedding_model_engine)
        ...
        #self.embedding = OpenAIEmbeddings(deployment="text-emb-ada-002")
    ...
    def prepare_and_save_vectordb(self):
        ...
        #print("Embedding model engine:", self.embedding)
        #embedding1=OpenAIEmbeddings(deployment="text-emb-ada-002")
       # print("\n\n Embedding model enginetttt=", embedding1)
        vectordb = Chroma.from_documents(
            documents=chunked_documents,
            #embedding=OpenAIEmbeddings(deployment="text-emb-ada-002"), # OpenAIEmbeddings(),
